...
import { EXERCISES } from '../components/stepperInspectData';
    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
      ...
      <main style={{ flex: 1 }}>
        ...
        <section className="courses-section">
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            <h2 className="courses-section__heading">Three Short Courses</h2>
            <p className="courses-section__sub">
              Each course is a standalone microlearning — open it, work through it, close it.
              No account, no progress tracking, no prerequisites between them.
            </p>
            <div className="courses-grid">

              <div className="course-card course-card--soon">
                <div className="course-card__num">Course 01</div>
                <div className="course-card__title">Write from Scratch</div>
                <ul className="course-card__outcomes">
                  <li>Read and write a valid HTML document structure</li>
                  <li>Use text, link, image, and list tags correctly</li>
                  <li>Apply basic CSS: color, spacing, fonts, layout</li>
                </ul>
                <div className="course-card__meta">
                  <span>5 lessons · ~30 min</span>
                </div>
                <span className="course-card__cta course-card__cta--soon">Coming soon</span>
              </div>

              <div className="course-card course-card--active">
                <div className="course-card__num">Course 02</div>
                <div className="course-card__title">Edit an Existing File</div>
                <ul className="course-card__outcomes">
                  <li>Recognise the three blocks of any AI-generated HTML file</li>
                  <li>Find and change text, styles, and data without breaking anything</li>
                  <li>Add and modify interactions in a live editor</li>
                </ul>
                <div className="course-card__meta">
                  <span>3 lessons · ~20 min</span>
                </div>
                <a
                  href="/OwnWhatAIBuilds/courses/edit-existing-file/index.html"
              ...
              <div className="course-card course-card--soon">
                <div className="course-card__num">Course 03</div>
                <div className="course-card__title">Structure Your Files</div>
                <ul className="course-card__outcomes">
                  <li>Understand how HTML, CSS, and JS files reference each other</li>
                  <li>Write prompts that produce maintainable multi-file output</li>
                  <li>Organise a course folder AI can extend without breaking</li>
                </ul>
                <div className="course-card__meta">
                  <span>4 lessons · ~25 min</span>
                </div>
                <span className="course-card__cta course-card__cta--soon">Coming soon</span>
              </div>
...
function go(dir) {
  ...
  ...
                ...
                <a
                  href="/OwnWhatAIBuilds/downloads/stepper.html"
                ...
                <StepperInspectBlock exercises={EXERCISES} />
              </>
            )}
