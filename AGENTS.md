...
- Memory index: `C:\Users\glady\.Codex\projects\E--Portfolio-site\memory\MEMORY.md`
...
**The exact procedure:**
1. Open the page in the real browser via **Codex-in-Chrome** (not WebFetch). Create a tab group, navigate, approve the screenshot permission for `wixstudio.com`.
...
- Launch config: `E:\Portfolio\Wix assets\.Codex\launch.json`
...
**Tools:** Power BI, SQL, Codex API (Anthropic)
...
- "Ask the Owl" bot: Codex API integration for on-demand report interpretation for stakeholders
